        ...
        function ($stateProvider, $urlRouterProvider, $locationProvider) {
                ...
                .state("restricted", {
                    ...
                    resolve: {
                        ...
                        user_data: function($http,$state,__env){
	                        return $http({ method: 'GET', url: __env.apiUrl()+'/core/ujson' })
	                            .then(function (data) {
	                            	return data.data.ujson;
	                            })
            ...
            // -- PAGES --
                ...
                .state("restricted.pages.help", {
                    url: "/help",
                    templateUrl: 'app/custom/pages/staus/helpView.html',
                    controller: 'helpCtrl',
                    resolve: {
                        deps: ['$ocLazyLoad', function($ocLazyLoad) {
                            return $ocLazyLoad.load([
                                'app/custom/pages/staus/helpController.js'
                            ],{serie: true});
                        }],
