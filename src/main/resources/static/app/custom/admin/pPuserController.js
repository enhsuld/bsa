angular
    .module('altairApp')
    .controller("userCtrl",['$rootScope','$scope','p_plan','p_role','user_data','mainService','$state','sweet','Upload','__env',
        function ($rootScope,$scope,p_plan,p_role,user_data,mainService,$state,sweet,Upload,__env) {
            ...
            $scope.puserGrid = {
                dataSource: {
                    ...
                    transport: {
                        read:  {
                            url: __env.apiUrl()+"/core/list/LutUser",
                ...
                columns: [
                    ...
                    { template: kendo.template($("#update").html()),  width: 120}
                ],
                dataBound: function () {
                    var rows = this.items();
                    $(rows).each(function () {
