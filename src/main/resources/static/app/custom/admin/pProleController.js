angular
    .module('altairApp')
    .controller("roleCtrl", ['$rootScope', '$scope', 'mainService', '$state', 'p_menu', 'user_data', '__env',
        function ($rootScope, $scope, mainService, $state, p_menu, user_data, __env) {
            ...
            $scope.sections = "";
            function initt() {
                mainService.withdomain('get', __env.apiUrl() + '/core/parentmenus')
                    .then(function (data) {
                        $scope.donelist = data;
            ...
            $scope.domain = "com.nbb.models.LutRole.";
            ...
            $scope.proleGrid = {
                dataSource: {
                    ...
                    transport: {
                        read: {
                            url: __env.apiUrl() + "/core/list/LutRole",
            ...
            $scope.update = function (vdata) {
                ...
                mainService.getDetail(__env.apiUrl() + '/core/action/read/' + $scope.domain + '/' + vdata.id)
                    .then(function (data) {
                        $scope.data = data;
            ...
            $scope.delMe = function (i) {
                mainService.withdomain('get', __env.apiUrl() + '/core/action/delete/' + $scope.domain + '/' + i)
                    .then(function () {
                        $(".k-grid").data("kendoGrid").dataSource.read();
                    });
            }
            ...
            $scope.submitForm = function () {
                ...
                jQuery.ajax({
                    url: __env.apiUrl() + "/core/rolesubmit",
                    type: 'PUT',
                    dataType: 'json',
